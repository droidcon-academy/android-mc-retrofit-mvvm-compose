...
class MoviesRepositoryImpl @Inject constructor(private val TMDBApi: TMDBApi) : MoviesRepository {
    ...
    /**
     * This function is making a call to the TMDB Api to fetch a list of popular movies.
     * Then emitting the response gotten based on if the request was successful or not
     */
